...
少人数スタートアップでは、1人がAI活用でGTM全体（ICP設計→リード獲得→CRM→営業オペ→分析改善）を統合的に回す「GTMエンジニア」が重要。ローンチ戦略はGTMの中核であり、単発イベントではなく継続的なGTMサイクルの一部として設計すること。
...
- Blog
- Podcast
- Branded community (team chat, Discord)
- Website/product
...
- Marketplaces (Shopify, team chat): Optimize listing → drive to site for more
