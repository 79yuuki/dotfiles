---
name: social-content
description: "When the user wants help creating, scheduling, or optimizing social media content for LinkedIn, Instagram, TikTok, Facebook, or other non-X platforms. Also use when the user mentions 'LinkedIn post,' 'social media,' 'content calendar,' 'social scheduling,' 'engagement,' or 'viral content.' For X/Twitter posts, use x-cmo instead. This skill covers content creation, repurposing, and platform-specific strategies for non-X platforms."
---
